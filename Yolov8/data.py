...
# Use the model
model.train(data="C:\GitFiles\Projet-reconaissance-de-panneaux\Detection_panneaux3\data.yaml", epochs=50, patience=5)  # mettre le chemin absolu vers data.yaml
