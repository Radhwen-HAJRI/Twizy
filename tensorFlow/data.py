...
label_map = load_label_map('Detection_panneaux/test/objects_label_map.pbtxt')#label_map_path
print("TAILLE MAP §§§",len(label_map))

raw_dataset = tf.data.TFRecordDataset("Detection_panneaux/train/objects.tfrecord")
count = 0
...
# Crée le dataset
util = Tools("Detection_panneaux/train/objects.tfrecord"
                ,"Detection_panneaux/test/objects.tfrecord"
                ,"Detection_panneaux/valid/objects.tfrecord")
...
model.save("Detection_panneaux/my_model.keras")
